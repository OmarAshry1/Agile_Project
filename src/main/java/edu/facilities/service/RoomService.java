...
public class RoomService {
    ...
    private void seedSampleRooms() {
        ...
        createRoom("C101", "Classroom 101", RoomType.CLASSROOM, 40,
                "Science Building|1st Floor|Projector, Whiteboard", RoomStatus.AVAILABLE);
        createRoom("L205", "Lab 205", RoomType.LAB, 24,
                "Engineering Hall|2nd Floor|Computers, Oscilloscopes", RoomStatus.OCCUPIED);
        createRoom("H300", "Hall 300", RoomType.CONFERENCE, 80,
                "Main Auditorium|3rd Floor|Stage, Audio System", RoomStatus.MAINTENANCE);
    }
}
